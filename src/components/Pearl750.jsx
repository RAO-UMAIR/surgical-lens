function Pearl750() {
  const product = {
    image: "/images/products-images/PEARL-750.png",
    literature: "/images/products-images/pearl-Literature.pdf",
    title: "PEARL",
    description: "Premium Intraocular Lens",
  };
