function ACIOL55D() {
  const product = {
    image: "/images/products-images/AC-IOL-5.5D.png",
    literature: "/images/products-images/AC-IOL-5.5D-Literature.pdf",
    title: "AC IOL 5.5D",
    description: "Anterior Chamber Intraocular Lens",
  };
