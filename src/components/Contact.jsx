...
function Contact() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setIsScrollingDown(current > lastScrollY.current);
  ...
  return <div>
    ...
    <div className="mt-6">
      ...
      <div className="mt-6 md:mt-14 flex flex-col items-center gap-6 md:flex-row md:justify-around">
        {isScrollingDown ? (
          <Fade className="w-full flex justify-center" direction="up">
          ...
          <div className="w-full flex justify-center">
            <div className="w-full max-w-xs min-h-[190px] rounded-2xl border border-white/60 bg-white/80 p-4 shadow-xl backdrop-blur">
              <div className="mb-4 flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-700">
                  <IoCall className="text-2xl"/>
                </div>
